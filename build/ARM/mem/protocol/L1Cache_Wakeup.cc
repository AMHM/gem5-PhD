// Auto generated C++ code started by /PhD_Accounts/Phd_Accounts/a.monazzah/gem5-PhD/src/mem/slicc/symbols/StateMachine.py:1055
                                                    ...
                                                    if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_WB_NACK)) {
                                                        ...
                                                        ;
                                                            ...
                                                            if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_INV)) {
                                                                ...
                                                                panic("Runtime Error at MI_example-cache.sm:224: %s.\n", ("Unexpected message"));
                                                                ;
                                                            }
                                                        }
                                                    }
                                ...
                                L1Cache_TBE* tbe
                                 = (((*m_TBEs_ptr)).lookup(((*in_msg_ptr)).m_addr));
                                    if ((((*in_msg_ptr)).m_Type == CoherenceResponseType_DATA)) {
                                        ...
                                        panic("Runtime Error at MI_example-cache.sm:241: %s.\n", ("Unexpected message"));
                                        ;
                                    }
                                    }
                                }
