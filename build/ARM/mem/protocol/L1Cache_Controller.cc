...
L1Cache_Controller::b_issuePUT(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:282: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:295: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:309: %s.\n", "assert failure");
...
L1Cache_Controller::r_load_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:357: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:358: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:365: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:366: %s\n", (*m_cache_entry_ptr).m_DataBlk);
(((*m_cacheMemory_ptr)).setMRU(m_cache_entry_ptr));
...
L1Cache_Controller::s_store_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:374: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:375: %s\n", (*m_cache_entry_ptr).m_DataBlk);
(((*m_cacheMemory_ptr)).setMRU(m_cache_entry_ptr));
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:382: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:383: %s\n", (*m_cache_entry_ptr).m_DataBlk);
(((*m_cacheMemory_ptr)).setMRU(m_cache_entry_ptr));
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:392: %s.\n", "assert failure");
...
L1Cache_Controller::forward_eviction_to_cpu(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
           if (m_send_evictions) {
        DPRINTF(RubySlicc, "MI_example-cache.sm:399: Sending invalidation for %#x to the CPU\n", addr);
...
L1Cache_Controller::x_copyDataFromCacheToTBE(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:415: %s.\n", "assert failure");
            ...
            if ((param_type == RubyRequestType_IFETCH)) {
                return L1Cache_Event_Ifetch;
                    ...
                    if (((param_type == RubyRequestType_ST) || (param_type == RubyRequestType_ATOMIC))) {
                        ...
                        panic("Runtime Error at MI_example-cache.sm:127: %s.\n", ("Invalid RubyRequestType"));
                        ;
                    }
                }
            }
